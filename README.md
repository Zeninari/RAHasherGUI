...
also you can overwrite the version of RAHasher by placing the EXE next to my EXE, if one exists, it will use that version of RA Hasher instead. if you find any bugs or crashes do send an issue report to me.
